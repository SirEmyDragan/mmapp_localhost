...
// Production DB URL or Development DB URL:
const dbUrl = 'mongodb://localhost:27017/mmapp'; // process.env.DB_URL || 
...
//Production Secret or Development Secret:
    ...
    helmet.contentSecurityPolicy({
        directives: {
            ...
            imgSrc: [
                ...
                "blob:",
                "data:",
                "https://res.cloudinary.com/specterdev/", //SHOULD MATCH YOUR CLOUDINARY ACCOUNT! 
...
// app.all is for every request, * is the path
